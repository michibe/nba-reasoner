 ...
 * Beantwo
 */
public class LooseCounterRating extends NbaRatingImplAbs {



    public LooseCounterRating(@NotNull NbaRatingConfig nbaRatingConfig) {
        super(nbaRatingConfig, RatingScale.MIN_BETTER, "Calculates the average Cost of the cases that occur for the NbaProposal.", "LooseCounterRating");
    }
    ...
    public double rate(NbaProposal nbaProposal) {
        ...
        double result = winCounter-looseCounter;
